...
namespace Game.Scripts.ECS.Systems
{
    public class TestSystem : IEcsRunSystem
    {
        ...
        public void Run()
        {
            ...
            DragonView dragonView = DragonFactory.CreateDragon(_staticData, dragonType, RandomPosition.GetRandomSpawnPosition(_sceneData), RandomRotation.GetRandomRotation());
            ...
            _staticData.DragonsStats.TryGetValue(dragonType, out var stats);
